    ...
    <div class="main">
        <div class="content-wrap">
            ...
            <a-timeline >
                ...
                <a-timeline-item color="#00000040"  v-for="(item,index) in cateLineList" :key="item.id">
...
import { getCateLineList} from '@/axios/blog';
import {CateLineType} from '@/types/cate'
...
export default defineComponent({
    ...
    setup() {
        ...
        const data = reactive(new CateLineType());
        onMounted(() => {
            getdata();
        })
        const getdata = () => {
            spinning.value = true;
            getCateLineList({id}).then((res: any) => {
                spinning.value = false;
                data.cateLineList = res.data.list;
